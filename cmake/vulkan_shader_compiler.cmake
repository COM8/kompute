function(vulkan_compile_shader)
     ...
     cmake_parse_arguments(SHADER_COMPILE "" "INFILE;OUTFILE;OUTDIR;NAMESPACE;RELATIVE_PATH" "" ${ARGN})

     if(NOT SHADER_COMPILE_OUTDIR)
          set(SHADER_COMPILE_OUTDIR ${CMAKE_CURRENT_BINARY_DIR})
     endif()

     set(SHADER_COMPILE_INFILE_FULL "${CMAKE_CURRENT_SOURCE_DIR}/${SHADER_COMPILE_INFILE}")
     set(SHADER_COMPILE_SPV_FILE_FULL "${SHADER_COMPILE_OUTDIR}/${SHADER_COMPILE_INFILE}.spv")
     set(SHADER_COMPILE_HEADER_FILE_FULL "${SHADER_COMPILE_OUTDIR}/${SHADER_COMPILE_OUTFILE}")
